...
namespace Runtime.ProceduralAnimation
{
    public class ProceduralWalkAnimator : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            _lastPos = _currentPos = _transform.position;
        }
        ...
        private void RotateForward(Vector3 direction)
        {
            Quaternion targetRotation = Quaternion.LookRotation(direction);
            _transform.rotation = Quaternion.Slerp(_transform.rotation, targetRotation, Time.deltaTime * _speed);
        }
